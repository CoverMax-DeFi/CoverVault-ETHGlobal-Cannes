  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">Help Others & Earn Extra Money</h1>
        ...
        <div className="grid grid-cols-1 gap-6 mb-8">
          <div className="md:col-span-3 lg:col-span-2">
            <Card>
              <CardHeader>
                <CardTitle>How Helping Others Works</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4 text-sm">
                <p>
                  <strong>Extra Money:</strong> When you help others, you earn the normal interest rate of {(aaveInterestRate * 100).toFixed(1)}% to {(compoundInterestRate * 100).toFixed(1)}%, plus a {(lpBoost * 100).toFixed(0)}% bonus for being helpful.
                </p>

                <p>
                  <strong>Money Changes:</strong> How much you earn can change if people suddenly want more protected accounts or more regular accounts, especially during emergencies.
                </p>

                <p>
                  <strong>Emergency Times:</strong> During emergencies, everyone wants protected accounts more than regular ones, which can change how much you earn for helping.
                </p>

                <p>
                  <strong>Fair Pay:</strong> The {(lpBoost * 100).toFixed(0)}% bonus is your reward for helping out. Think about how comfortable you are before deciding how much to help with.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <Card>
            <CardHeader>
              <CardTitle>Start Helping Others</CardTitle>
              <CardDescription>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Stop Helping</CardTitle>
              <CardDescription>
        ...
        <h2 className="text-xl font-semibold mb-4">What If Things Change?</h2>
        <Card>
          <CardContent className="p-6">
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="font-medium mb-4">What People Want Calculator</h3>
                ...
                <div>
                  <h3 className="font-medium mb-4">How It Affects You</h3>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Money Impact:</span>
                      <span className="font-medium text-red-500">-{impermanentLossPercent.toFixed(2)}%</span>
                    </div>
